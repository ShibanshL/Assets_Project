...
import { useStore_2, useStore_3, useStore_1,useStore,useStore_7,useStore_8,useStore_9,useStore_4 } from '../Store';
  ...
  return (
   <Grid p='0 7vw' style={{}}>
        <Grid.Col span={12} style={{}}>
            <Grid>
              <Grid.Col span={6}>
                  <Text size='xl' style={{fontSize:'34px',cursor:'pointer'}} weight={700}><Link style={{color:'#1b7acf', textDecoration:'none'}} to='/'>VLCM</Link></Text>
              </Grid.Col>
              <MediaQuery  query='(min-width:1000px)' styles={{display:'none'}}>
                <Grid.Col span={6}>
                  <Group pt='8px' align='right' position='right'>
                    <Burger
                      opened={opened}
              ...
              <MediaQuery query='(max-width:1000px)' styles={{display:'none'}}>
                <Grid.Col span={6}>
                  <Group position='right' p='10px'>
                    <Group p='5px 10px'>
                      <Text weight={600}>
                        <Link to='/' style={{fontFamily:'sans-serif', textDecoration:'none', fontSize:'14px', color:'#228be6'}}>Home</Link>
                      </Text>
                    </Group>
                    <Group p='5px 10px'>
                      <Text weight={600}>
